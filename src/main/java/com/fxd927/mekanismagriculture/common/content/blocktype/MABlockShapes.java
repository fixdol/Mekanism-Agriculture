...
public class MABlockShapes {
    private MABlockShapes() {
    }
    ...
    public static final VoxelShape[] HIGH_SPEED_FORCING_MACHINE = new VoxelShape[EnumUtils.HORIZONTAL_DIRECTIONS.length];
    public static final VoxelShape[] HIGH_SPEED_FORCING_MACHINE_FACTORY = new VoxelShape[EnumUtils.HORIZONTAL_DIRECTIONS.length];
    ...
    static {
        ...
        VoxelShapeUtils.setShape(VoxelShapeUtils.combine(
                ...
                box(16, 5, 5, 16, 11, 11), // portLED1
                box(0, 5, 5, 0, 11, 11) // portLED2
        ), HIGH_SPEED_FORCING_MACHINE_FACTORY);
    }
}
